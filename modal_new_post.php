...
<form class="new_post_form" action="#" method="post">
    ...
    <textarea class="new_post_question" rows="4" cols="100" name="text" placeholder="Введите вопрос"></textarea>
    ...
    <textarea class="new_post_variant_3" rows="4" cols="100" name="text" placeholder="Третий вариант ответа"></textarea>
